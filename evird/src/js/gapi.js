...
(function () {
    ...
    var C = g, D = document, aa = C.location, ba = function () {
    }, ca = /\[native code\]/, F = function (a, b, c) {
        return a[b] = a[b] || c
    }, da = function (a) {
        for (var b = 0; b < this[A]; b++)if (this[b] === a)return b;
        return -1
    }, ea = function (a) {
        a = a.sort();
        ...
        var a;
        if ((a = Object.create) && ca[x](a))a = a(null); else {
            a = {};
    ...
    S[t](["jsl", function (a) {
        ...
        if (b = a.u)a = F(I, "us", []), a[t](b), (b = /^https:(.*)$/.exec(b)) && a[t]("http:" + b[1])
    }]);
    var ha = /^(\/[a-zA-Z0-9_\-]+)+$/, ia = /^[a-zA-Z0-9\-_\.,!]+$/, ja = /^gapi\.loaded_[0-9]+$/, ka = /^[a-zA-Z0-9,._-]+$/, oa = function (a, b, c, d) {
        var e = a[s](";"), h = R[e[m]()], l = null;
        h && (l = h(e, b, c, d));
        if (b = l)b = l, c = b.match(la), d = b.match(ma), b = !!d && 1 === d[A] && na[x](b) && !!c && 1 === c[A];
        b || T(a);
        return l
    }, qa = function (a, b, c, d) {
        a = pa(a);
        ...
        for (var b = a.substring(1)[s]("/"), c = []; b[A];) {
            a = b[m]();
            if (!a[A] || 0 == a.indexOf("."))T("empty/relative directory"); else if (0 < a.indexOf("=")) {
                b.unshift(a);
                break
            }
            c[t](a)
        ...
        "jsl": {
            "ci": {
                ...
                "iframes": {
                    ...
                    "managers": {"url": ":socialhost:/:session_prefix:_/widget/render/managers?usegapi\u003d1"},
                    "visibility": {
                        "params": {"url": ""},
                ...
                "deviceType": "desktop",
                "inline": {"css": 1},
                "lexps": [99, 97, 79, 109, 45, 17, 117, 115, 81, 127, 123, 122, 61, 30],
            ...
            "h": "m;/_/scs/apps-static/_/js/k\u003doz.gapi.en.dXaY4wFPegI.O/m\u003d__features__/am\u003dAQ/rt\u003dj/d\u003d1/t\u003dzcms/rs\u003dAGLTcCORdZkJIIQQ1zpx2loGrb-KTPf3oA",
            "u": "https://apis.google.com/js/client.js",
            "hee": true,
            "fp": "91b4c6a74020c59d7dec5b192926b4edd3140b50",
            "dpo": false
        },
        "fp": "91b4c6a74020c59d7dec5b192926b4edd3140b50",
